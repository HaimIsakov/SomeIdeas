...
class TrainTestValOneTime:
    def __init__(self, model, RECEIVED_PARAMS, train_loader, test_loader, loss_weights, device):
        self.model = model
        self.train_loader = train_loader
        self.test_loader = test_loader
        self.loss_weights = loss_weights  # אפשר לחשב אותו במחלקה הזאת לא צריך להעביר לו את המשתנה הזה כפרמטר מראש
        self.device = device
